  ...
  const handleClick = (data: DataProps) => {
    ...
    switch (data && data.action) {
      ...
      case 'remove':
        ...
        break;
      case 'dropnuovo':
        fetchNui('dropnuovo', { item: item, inventory: 'player' });
        break;      
      case 'ripara_arma':
        fetchNui('ripara_arma', { slot: data?.slot });
        break;   
      case 'removeAmmo':
  ...
  return (
    <>
      <Menu>
        ...
        <MenuItem onClick={() => handleClick({ action: 'dropnuovo' })} label={Locale.ui_drop || 'Drop'} />
